...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        {
            // has been seeded
            if (this._context.Department.Any() || this._context.Seller.Any() || this._context.SalesRecord.Any()) return;
            ...
            Seller seller1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 04, 21), 1048.00, department1);
            Seller seller2 = new Seller(2, "Sheila", "sheila@gmail.com", new DateTime(1988, 05, 18), 1048.00, department2);
            Seller seller3 = new Seller(3, "Weslei", "weslei@gmail.com", new DateTime(1997, 01, 08), 1048.00, department3);
            Seller seller4 = new Seller(4, "Anna", "anna@gmail.com", new DateTime(1999, 03, 28), 1048.00, department4);
            Seller seller5 = new Seller(5, "BTomas", "tomas@gmail.com", new DateTime(2000, 02, 21), 1048.00, department1);
            Seller seller6 = new Seller(6, "Maria", "maria@gmail.com", new DateTime(1988, 09, 01), 1048.00, department2);


            SalesRecord salesRecord01 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, seller1);
            SalesRecord salesRecord02 = new SalesRecord(2, new DateTime(2018, 09, 4), 7000.0, SaleStatus.Billed, seller5);
            SalesRecord salesRecord03 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SaleStatus.Canceled, seller4);
            SalesRecord salesRecord04 = new SalesRecord(4, new DateTime(2018, 09, 1), 8000.0, SaleStatus.Billed, seller1);
            SalesRecord salesRecord05 = new SalesRecord(5, new DateTime(2018, 09, 21), 3000.0, SaleStatus.Billed, seller3);
            SalesRecord salesRecord06 = new SalesRecord(6, new DateTime(2018, 09, 15), 2000.0, SaleStatus.Billed, seller1);
            SalesRecord salesRecord07 = new SalesRecord(7, new DateTime(2018, 09, 28), 13000.0, SaleStatus.Billed, seller2);
            SalesRecord salesRecord08 = new SalesRecord(8, new DateTime(2018, 09, 11), 4000.0, SaleStatus.Billed, seller4);
            SalesRecord salesRecord09 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.Pending, seller6);
            ...
            this._context.Department.AddRange(department1, department2, department3, department4);
            this._context.Seller.AddRange(seller1, seller2, seller3, seller4, seller5, seller6);
            this._context.SalesRecord.AddRange(
                salesRecord01,
                salesRecord02,
                salesRecord03,
                salesRecord04,
